...
pub fn GatePassEdit(#[props(into)] id: String) -> Element {
    ...
    let mut gate_pass_value = if new_gate_pass() {
        json!({})
    } else {
    ...
    rsx! {
        QuizEditorView {id, new_gate_pass, gate_pass_value}
    }
}

#[component]
fn QuizEditorView(id: Memo<String>, new_gate_pass: Memo<bool>, gate_pass_value: Value) -> Element {
    ...
    rsx! {
        form {
            ...
            FormDateField {
                ...
                required: true,
                initial_value: gate_pass_value.key_string("expired_at"),
            }
            // owner
            FormTextField {
                name: "owner_first_name",
                title: "field-owner-first-name",
                required: true,
                initial_value: owner.key_string("first_name"),
            }
            FormTextField {
                name: "owner_middle_name",
                title: "field-owner-middle-name",
                required: true,
                initial_value: owner.key_string("middle_name"),
            }
            FormTextField {
                name: "owner_last_name",
                title: "field-owner-last-name",
                required: true,
            ...
            FormTextField {
                ...
                title: "field-vehicle-number-plate",
                required: true,
                initial_value: vehicle.key_string("number_plate"),
            }
            FormTextField {
                name: "vehicle_vin_code",
                title: "field-vehicle-vin-code",
                required: false,
                initial_value: vehicle.key_string("vin_code"),
            }
            FormTextField {
                name: "vehicle_manufacturer",
                title: "field-vehicle-manufacturer",
                required: true,
                initial_value: vehicle.key_string("manufacturer"),
            }
            FormTextField {
                name: "vehicle_model",
                title: "field-vehicle-model",
                required: false,
                initial_value: vehicle.key_string("model"),
            }
            FormTextField {
                name: "vehicle_color",
                title: "field-vehicle-color",
                required: true,
                initial_value: vehicle.key_string("color"),
            }
            FormTextField {
                name: "vehicle_body_type",
                title: "field-vehicle-body-type",
                required: false,
                initial_value: vehicle.key_string("body_type"),
            }
        }
        EntryInfoBox {
